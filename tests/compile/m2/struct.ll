...
define i32 @main() {
entry:
  %call = call ptr @Point(i64 3, i64 4)
  %p = alloca ptr, align 8
  store ptr %call, ptr %p, align 8
  %p1 = load ptr, ptr %p, align 8
  %call2 = call i64 @distance_sq(ptr %p1)
  %printf_ret = call i32 (ptr, ...) @printf(ptr @fmt_int, i64 %call2)
